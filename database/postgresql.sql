CREATE TABLE characters (
  ...
  world_id INTEGER NOT NULL DEFAULT 100130,
  graphics_id INTEGER NOT NULL,
  display_name VARCHAR(16) NOT NULL DEFAULT '',
  date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  graphics_x SMALLINT NOT NULL,
  graphics_y SMALLINT NOT NULL,
  graphics_dim SMALLINT NOT NULL,
  x SMALLINT NOT NULL DEFAULT 122,
  y SMALLINT NOT NULL DEFAULT 245,
  level SMALLINT NOT NULL DEFAULT 0,
  points INTEGER NOT NULL DEFAULT 0,
  exp INTEGER NOT NULL DEFAULT 0,
  gold INTEGER NOT NULL DEFAULT 0,
  health_base INTEGER NOT NULL,
  health_effect_extra INTEGER NOT NULL,
  health_current INTEGER NOT NULL,
  mana_base INTEGER NOT NULL,
  mana_effect_extra INTEGER NOT NULL,
  mana_current INTEGER NOT NULL,
  attack_base INTEGER NOT NULL,
  attack_effect_extra INTEGER NOT NULL,
  defense_base INTEGER NOT NULL,
  defense_effect_extra INTEGER NOT NULL,
  damage_base INTEGER NOT NULL,
  damage_effect_extra INTEGER NOT NULL,
  skill_base INTEGER NOT NULL,
  skill_effect_extra INTEGER NOT NULL,
  magic_base INTEGER NOT NULL,
  magic_effect_extra INTEGER NOT NULL,
  healthregenerate_base INTEGER NOT NULL,
  healthregenerate_effect_extra INTEGER NOT NULL,
  manaregenerate_base INTEGER NOT NULL,
  manaregenerate_effect_extra INTEGER NOT NULL,
  custom_status_msg VARCHAR(32) NOT NULL DEFAULT '',
  direct SMALLINT NOT NULL DEFAULT 1,
...
CREATE TABLE friends (
  id SERIAL PRIMARY KEY,
  lower_id INTEGER NOT NULL DEFAULT 0,
  higher_id INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE inventory (
  ...
  graphics_id INTEGER NOT NULL DEFAULT 0,
  graphics_x SMALLINT NOT NULL DEFAULT 0,
  graphics_y SMALLINT NOT NULL DEFAULT 0,
  name VARCHAR(128) NOT NULL DEFAULT '',
  description VARCHAR(256) NOT NULL DEFAULT '',
  available_status VARCHAR(32) NOT NULL DEFAULT 'all',
  can_sell SMALLINT NOT NULL DEFAULT 1,
  can_drop SMALLINT NOT NULL DEFAULT 1,
  units SMALLINT NOT NULL DEFAULT 1,
  max_units SMALLINT NOT NULL DEFAULT 1,
  units_sell INTEGER NOT NULL DEFAULT 0,
  price INTEGER NOT NULL DEFAULT 1,
  health_effect INTEGER NOT NULL DEFAULT 0,
  mana_effect INTEGER NOT NULL DEFAULT 0,
  attack_effect INTEGER NOT NULL DEFAULT 0,
  defense_effect INTEGER NOT NULL DEFAULT 0,
  damage_effect INTEGER NOT NULL DEFAULT 0,
  skill_effect INTEGER NOT NULL DEFAULT 0,
  magic_effect INTEGER NOT NULL DEFAULT 0,
  healthregenerate_effect INTEGER NOT NULL DEFAULT 0,
  manaregenerate_effect INTEGER NOT NULL DEFAULT 0,
  action_effect_1 SMALLINT NOT NULL DEFAULT 0,
  action_effect_1_data VARCHAR(512) NOT NULL DEFAULT '',
  effect_duration INTEGER NOT NULL,
  required_skill INTEGER NOT NULL DEFAULT 0,
  required_magic INTEGER NOT NULL DEFAULT 0,
  frequency INTEGER NOT NULL DEFAULT 0,
  range INTEGER NOT NULL DEFAULT 0,
  premium SMALLINT NOT NULL DEFAULT 0,
  usage_type SMALLINT NOT NULL DEFAULT 0,
  equiped SMALLINT NOT NULL DEFAULT 0,
  belt SMALLINT NOT NULL DEFAULT -1
);
...
CREATE TABLE mob_spawning (
  ...
  respawn_delay INTEGER NOT NULL DEFAULT 5000
);
...
CREATE TABLE vars (
  id SERIAL PRIMARY KEY,
  char_id INTEGER NOT NULL DEFAULT 0,
  var_id INTEGER NOT NULL DEFAULT 0,
  val INTEGER NOT NULL DEFAULT 0
);

CREATE INDEX friends_lower_id_idx ON friends(lower_id);
CREATE INDEX friends_higher_id_idx ON friends(higher_id);
CREATE INDEX inventory_char_id_idx ON inventory(char_id);
CREATE INDEX vars_char_id_idx ON vars(char_id);

ALTER TABLE friends
  ADD CONSTRAINT friends_lower_id_fkey FOREIGN KEY (lower_id) REFERENCES characters(id) ON DELETE CASCADE,
  ADD CONSTRAINT friends_higher_id_fkey FOREIGN KEY (higher_id) REFERENCES characters(id) ON DELETE CASCADE;

ALTER TABLE inventory
  ADD CONSTRAINT inventory_char_id_fkey FOREIGN KEY (char_id) REFERENCES characters(id) ON DELETE CASCADE;

ALTER TABLE vars
  ADD CONSTRAINT vars_char_id_fkey FOREIGN KEY (char_id) REFERENCES characters(id) ON DELETE CASCADE;